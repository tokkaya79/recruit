...
const Additional = () => {
	return (
		<section className='additional'>
			<div className='container additional__container'>
				<div className='additional__info'>
					...
					<p className='additional__text'>
						As a growing community of global checking vendors, Trust Marketplace
						is an aggregator for enhanced due diligence in the online trust
						environment.
					</p>
